class MiniTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mini_type.save
        format.html { redirect_to mini_type_url(@mini_type), notice: "Mini type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @mini_type.update(mini_type_params)
        format.html { redirect_to mini_type_url(@mini_type), notice: "Mini type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mini_types_url, notice: "Mini type was successfully destroyed." }
  ...
  private
    ...
    def mini_type_params
      params.require(:mini_type).permit(:nome, :acronym)
    end
end
